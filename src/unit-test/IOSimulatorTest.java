...
class IOSimulatorTest {
    ...
    void test_comando_non_valido() {
        IOSimulator io = new IOSimulator(new String[]{"pippo", "fine"});
        new DiaDia(io).gioca();
    ...
    void test_vai_direzione_inesistente() {
        IOSimulator io = new IOSimulator(new String[]{"vai est", "vai est", "fine"});
        new DiaDia(io).gioca();
    ...
    void test_prendi_attrezzo_non_presente() {
        IOSimulator io = new IOSimulator(new String[]{"prendi spada", "fine"});
        new DiaDia(io).gioca();
    ...
    void test_prendi_attrezzo_presente() {
        ...
        IOSimulator io = new IOSimulator(new String[]{"prendi osso", "fine"});
        new DiaDia(io).gioca();
