...
/**
 * Test di riferimento del corso per LabirintoBuilder (link nell'Es. 6 del PDF,
 * branch materiale-per-hw3 del repo diadia), adattati alle evoluzioni
 * richieste dagli esercizi successivi dello stesso homework:
 * - JUnit 5 al posto di JUnit 4 (@BeforeEach, jupiter assertions);
 * - Labirinto.newBuilder() al posto di new LabirintoBuilder() (Es. 19);
 * - getDirezioni()/getMapStanzeAdiacenti() esprimono le direzioni con
 *   l'enum Direzione al posto delle stringhe (Es. 18).
 * Le fixture e le asserzioni semantiche sono quelle originali del prof.
 */
class LabirintoBuilderRiferimentoProfTest {

	private LabirintoBuilder labirintoBuilder;
	private final String nomeStanzaIniziale = "Atrio";
	private final String nomeStanzaVincente = "Uscita";
	...
	@Test
	void testMonolocaleConAttrezzo() {
		Labirinto monolocale = labirintoBuilder
	...
	@Test
	void testMonolocaleConAttrezzoSingoloDuplicato() {
		Labirinto monolocale = labirintoBuilder
				.addStanzaIniziale(nomeStanzaIniziale)
				.addAttrezzo("spada", 1)
				.addAttrezzo("spada", 1)
	...
	void testBilocale() {
		...
		assertEquals(List.of(Direzione.NORD), bilocale.getStanzaIniziale().getDirezioni());
		assertEquals(List.of(Direzione.SUD), bilocale.getStanzaVincente().getDirezioni());
	}
	...
	@Test
	void testTrilocaleConStanzaDuplicata() {
		labirintoBuilder
				.addStanzaIniziale(nomeStanzaIniziale)
	...
	@Test
	void testPiuDiQuattroAdiacenti() {
	...
	@Test
	void testImpostaStanzaInizialeCambiandola() {
		Labirinto maze = labirintoBuilder
	...
	@Test
	void testAggiuntaAttrezziAStanze_Iniziale() {
	...
	@Test
	void testAggiuntaAttrezziAStanze_AppenaAggiunte() {
		String nomeAttrezzo = "attrezzo";
		int peso = 1;
	...
	@Test
	void testAggiuntaAttrezzoAStanze_AppenaAggiunteMultiple() {
		String nomeAttrezzo = "attrezzo";
		int peso = 1;
		String nomeStanza = "stanza 1";
	...
	@Test
	void testAggiuntaAttrezzoAStanze_MoltepliciAttrezziStessaStanza() {
	...
	@Test // verifica che gli attrezzi vengano aggiunti all'ultima stanza aggiunta
	void testAggiuntaAttrezzoAStanze_AttrezzoAggiuntoAllaSecondaStanza() {
		String nomeAttrezzo1 = "attrezzo 1";
		String nomeAttrezzo2 = "attrezzo 2";
		int peso1 = 1;
		int peso2 = 2;
	...
	@Test
	void testAggiuntaAttrezzoAStanze_PrimoAttrezzoInUnaStanzaSecondoAttrezzoSecondaStanza() {
		String nomeAttrezzo1 = "attrezzo 1";
		String nomeAttrezzo2 = "attrezzo 2";
		int peso1 = 1;
		int peso2 = 2;
	...
	@Test
	void testLabirintoConStanzaMagica() {
		int sogliaMagica = 1;
	...
	@Test
	void testLabirintoConStanzaMagica_AggiuntaElementoOltreSogliaMagica() {
		String nomeAttrezzo1 = "attrezzo 1";
		String nomeAttrezzo2 = "attrezzo 2";
	...
	@Test
	void testLabirintoConStanzaBloccata_ConPassepartout() {
		this.labirintoBuilder
				.addStanzaIniziale(nomeStanzaIniziale)
		...
		// in presenza di passepartout la stanza bloccata ritorna la corretta adiacenza
		assertEquals(stanzaVincente, labirintoBuilder.getListaStanze().get("stanza bloccata").getStanzaAdiacente("nord"));
	}

	@Test
	void testLabirintoConStanzaBloccata_SenzaPassepartout() {
		this.labirintoBuilder
				.addStanzaIniziale(nomeStanzaIniziale)
		...
		// in mancanza di passepartout la stanza bloccata ritorna se stessa
		assertEquals(stanzaBloccata, labirintoBuilder.getListaStanze().get("stanza bloccata").getStanzaAdiacente("nord"));
	}

	@Test
	void testLabirintoCompletoConTutteLeStanze() {
		...
		assertTrue(corridoio.getDirezioni().containsAll(
				Arrays.asList(Direzione.OVEST, Direzione.EST, Direzione.NORD, Direzione.SUD)));
		Map<Direzione, Stanza> mapAdiacenti = new EnumMap<>(Direzione.class);
